...
var crc32Object = function(obj) {
	var sortObj = function (o) {
		...
		for(i in o) { 
			...
			a.push([i, (function() {
				if (typeof o[i] == 'object' && o[i].constructor != Array)
...
var d = new Date();
var obj = { b:"hello",c:["1","2"], a: {f:"2",c:"2",a:"2"}, b: function() { var x=3; }, x: d};
var obj1 = { b:"hello",c:["1","2"], a: {f:"2",c:"2",a:"2"}, b: function() { var x=3; }, x: d};

print(crc32Object(obj));
print(crc32Object(obj1));
